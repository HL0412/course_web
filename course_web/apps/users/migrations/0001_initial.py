    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('男', '男'), ('女', '女')], default='女', max_length=10, verbose_name='性别')),
                ...
                ('image', models.ImageField(default='image/default.png', upload_to='users/%Y/%m')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send_type', models.CharField(choices=[('注册', '注册'), ('注册', '找回密码')], max_length=10)),
